...
class Encryptor
{
    ...
    public function encodeStr($string = "")
    {
        ...
        $param = str_replace("/", "1_1", $this->encode($string));
        return $this->countChar2String($param, "=") . "A99." . str_replace("=", "", $param);
    }

    public function decodeStr($string = "")
    {
        $temp = explode("A99.", $string);
        $param = isset($temp[1]) ? $temp[1] . str_repeat("=", $temp[0]) : $temp[0];
        $param = str_replace("1_1", "/", $param);
    ...
    public function countChar2String($string = "", $char = false)
    {
