...
class BaseController extends Controller
{
    ...
    public function create()
    {
        return view(
            $this->getAddView(),
            [
                'more' => array_merge($this->moreDataForm(), $this->moreDataTambah()),
    ...
    public function edit($id)
    {
        ...
        return view(
            ...
            [
                'result' => $result,
                'more' => array_merge($this->moreDataForm(), $this->moreDataEdit($result)),
                'form' => $this->getFormView(),
    ...
    public function store()
    {
        try {
            ...
            $input = $this->changeInputSave($input);
    ...
    public function update($id)
    {
        ...
        try {
            ...
            $input = $this->changeInputSaveEdit($input, $oldData);
