...
class PostRequest extends BaseRequest
{
    ...
    {
        return [
            "{$this->input}.post_title_id" => "nullable|string|max:255",
            "{$this->input}.post_title_en" => "nullable|string|max:255",
            "{$this->input}.post_status" => "required",
            "{$this->input}.post_type" => "required",
    ...
    {
        return [
            "{$this->input}.post_title_id" => 'Judul',
            "{$this->input}.post_status" => 'Status',
            "{$this->input}.post_type" => 'Tipe Post',
