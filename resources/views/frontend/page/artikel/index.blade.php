                    ...
                    <div class="card-img-top">
                        <a href="{{ url('artikel') }}/{{ $post->post_slug }}">
                            <img class="card-img-top border-radius-0 hover-effect-2"
                                src="{{ $post->medium_thumbnail ?? $post->first_image ?? 'https://via.placeholder.com/261x196.png?text=No+Image' }}"
                    ...
                    <div class="card-body bg-light px-0 py-4 z-index-1">
                        ...
                        <div class="card-body p-0">
                            <h4 class="card-title alternative-font-4 font-weight-semibold text-5 mb-3"><a
                                    ...
                                    href="{{ url('artikel') }}/{{ $post->post_slug }}">{{ $post->post_title }}</a></h4>
                            <p class="card-text mb-2 post-excertp">{{ $post->post_excerpt }}</p>
                            <a href="{{ url('artikel') }}/{{ $post->post_slug }}"
